...
public class RecyclerViewHandler implements LoadMoreHandler {
    ...
    public void checkIsScrollBottom() {
        recyclerViewOnScrollListener.onScrollStateChanged(recyclerView,RecyclerView.SCROLL_STATE_IDLE);
    }
    ...
    public void setOnScrollBottomListener(View contentView, OnScrollBottomListener onScrollBottomListener) {
        ...
        recyclerViewOnScrollListener = new RecyclerViewOnScrollListener(onScrollBottomListener);
