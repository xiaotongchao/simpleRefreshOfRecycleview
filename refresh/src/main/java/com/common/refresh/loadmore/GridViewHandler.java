...
public class GridViewHandler implements LoadMoreHandler {
    ...
    public void checkIsScrollBottom() {
        gridViewOnScrollListener.onScrollStateChanged(mGridView,OnScrollListener.SCROLL_STATE_IDLE);
    }
    ...
    public void setOnScrollBottomListener(View contentView, OnScrollBottomListener onScrollBottomListener) {
        ...
        gridViewOnScrollListener = new GridViewOnScrollListener(onScrollBottomListener);
