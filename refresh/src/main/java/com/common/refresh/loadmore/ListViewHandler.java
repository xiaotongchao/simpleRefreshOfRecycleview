...
import com.common.refresh.loadmore.ILoadMoreViewFactory.FootViewAdder;
import com.common.refresh.loadmore.ILoadMoreViewFactory.ILoadMoreView;
...
public class ListViewHandler implements LoadMoreHandler {
    ...
    public void setOnScrollBottomListener(View contentView, OnScrollBottomListener onScrollBottomListener) {
        ...
        listViewOnScrollListener= new ListViewOnScrollListener(onScrollBottomListener);
    ...
    @Override
    public void checkIsScrollBottom() {
        if(listViewOnScrollListener!=null){
            listViewOnScrollListener.onScrollStateChanged(mListView,OnScrollListener.SCROLL_STATE_IDLE);
        }
