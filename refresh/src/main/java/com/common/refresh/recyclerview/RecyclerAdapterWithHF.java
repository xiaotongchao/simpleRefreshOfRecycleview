...
public class RecyclerAdapterWithHF extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public final void onBindViewHolder(final RecyclerView.ViewHolder vh, int position) {
        ...
        if (isHeader(position)) {
            ...
            StaggeredGridLayoutManager.LayoutParams clp1 = (StaggeredGridLayoutManager.LayoutParams) cardView.getLayoutParams();
    ...
    private void prepareHeaderFooter(HeaderFooterViewHolder vh, View view) {
        ...
        Log.e("====ManagerType======",mManagerType+"=");
    ...
    public RecyclerAdapterWithHF(BaseRecycleAdapter adapter) {
        super();
